...
/**
 * This frame contains a combo box to select a shape and a component to _3_draw it.
 */
...
class ShapeComponent extends JComponent
{
   ...
   /**
    * Set a shape maker and initialize it with a random point _2_set.
    * @param aShapeMaker a shape maker that defines a shape from a point _2_set
    */
...
/**
 * A shape maker can make a shape from a point _2_set. Concrete subclasses must return a shape in
...
abstract class ShapeMaker
{
   ...
   /**
    * Makes a shape out of the given point _2_set.
