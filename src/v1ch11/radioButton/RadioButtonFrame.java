...
/**
 * A frame with a sample text label and radio buttons for selecting _4_font sizes.
 */
public class RadioButtonFrame extends JFrame
{
   ...
   /**
    * Adds a radio _5_button that sets the _4_font size of the sample text.
